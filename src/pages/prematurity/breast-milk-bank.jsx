...
export default function BreastMilkBank() {
  return (
    <Layout coverTitle="דף מידע להורים בנושא חלב אם מבנק חלב אם">
      <div className="page-container">
        <div className="main-content">
          <div className="sub-title">דף מידע להורים בנושא חלב אם מבנק חלב אם</div>
          <p>
            ...
            בחלב אם עד גיל שנה ואף יותר מכך לפגים וילודים חולים יש השפעה על
            הורדת תחלואה ותמותה בטווח הקרוב והרחוק.
          </p>

          <p>
            הנקה ישירה ולפי דרישה, לעתים קרובות אינה אפשרית בתקופה ראשונה לפגים
          ...
          <p>
            ...
            (NEC), אלח דם מאוחר (LOS), במחלת ריאות כרונית (BPD) וברטינופטיה של
          ...
          <p>
            ...
            מבנק חלב אם מוכר העומד בדרישות הבינלאומיות ורק בהעדרו, תמ"ל (תרכובת
          ...
          <p>
            מבחינה הלכתית דתית-רב בית החולים, יעקב קיהן מציין שאין איסור הלכתי
            להזנת תינוק בחלב אם מתורמת נוכרייה, או מתורמת יהודייה שאיננה שומרת
            מצוות (ראה נספח <PdfLink fileName='milk_donation_rav_letter' text='כתב הלכה'/>).
          </p>
