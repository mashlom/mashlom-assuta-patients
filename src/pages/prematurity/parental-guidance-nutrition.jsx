...
export default function NutritionalGuidancePreRelease() {
  return (
    <Layout coverTitle="הדרכה תזונתית לקראת שחרור מהפגייה">
      <div className="page-container">
        <div className="main-content">
          <div className="sub-title">הדרכה תזונתית לקראת שחרור מהפגייה</div>
          <p>הורים יקרים,</p>
          <p>
            מזל טוב לקראת השחרור הביתה. <br /> בדף הדרכה זה ריכזנו מידע העונה על
          ...
          <p>
            ...
            הביתה. <br /> ההדרכה תינתן ע"י אחות יועצת הנקה.
          </p>
          ...
          <ul className="numbered-list">
            ...
            <li>
              ...
              חלבון, ויטמינים, ומינרלים. ומותאמים לדרישות התזונתיות המוגברות של
              הפגים.
            </li>
            <li>תמ"לים מיוחדים ע"פי התוויה רפואית.</li>
          </ul>
          ...
          <p>
            מומלץ להימנע משינויים תכופים בתמ"ל לכן לפני כל שינוי רצוי להתייעץ עם
